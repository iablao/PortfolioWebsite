...
These are some of the projects that I've done!         </h1>
          {/* Line Spacer */}
          <div
            style={{
              width: "66%",
          ...
          <li>💻 CodeCraft: An AI-driven code optimizer for Python applications.</li>
    <li>🎨 PixelPerfect: A tool for automatic professional photo enhancements.</li>
    <li>⏲️ SmartTimer: An IoT-enabled countdown timer for smart home systems.</li>
    <li>🤖 RoboGuide: Autonomous navigation system for warehouse logistics.</li>
    <li>🌱 EcoTrack: Sustainability app to monitor and reduce your carbon footprint.</li>
</ul>
